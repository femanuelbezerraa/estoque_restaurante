...
def cadastro_produto():
    if request.method == 'POST':
        ...
        if existente:
            ...
            id_produto = Produto.criar(nome, descricao, quantidade, preco, quantidade_minima, tipo, especie, dosagem, validade)
...
def editar_produto(id_produto):
    ...
    if request.method == 'POST':
        ...
        Produto.atualizar(id_produto, nome=nome, quantidade=quantidade, quantidade_minima=quantidade_minima, tipo=tipo)
        return redirect(url_for('cadastro_produto'))
...
def adicionar_quantidade(produto_id):
    if request.method == 'POST':
        ...
        Movimentacao.registrar_entrada(id_produto, q, session['usuario_id'])
    return redirect(url_for('cadastro_produto'))
